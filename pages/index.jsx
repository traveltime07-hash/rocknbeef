...
export default function Home() {
  ...
  // Dane kontaktowe + linki (podane przez Ciebie)
  const CONTACT = {
  ...
  // Mapa (ma być na samym dole)
  const MAP_IFRAME_SRC =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2459.5527136925057!2d15.476904176899577!3d51.942111678853266!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x470613f002e97b19%3A0xa29f24cc18ff1b6c!2sSteakHouse%20Rock'n'BEEF!5e0!3m2!1spl!2spl!4v1758896343133!5m2!1spl!2spl";
  ...
  return (
    <>
      {/* HEADER — logo po lewej, przełącznik języka po prawej */}
      <header className="py-4 px-6 sticky top-0 z-40 bg-black/60 backdrop-blur">
        <div className="max-w-6xl mx-auto flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2">
            {/* Ikona z /public (zmień ścieżkę, jeśli masz inną nazwę) */}
            <Image src="/icon-32.png" alt="Rock’nBEEF" width={32} height={32} priority />
            <span className="text-xl font-extrabold tracking-tight">Rock’nBEEF</span>
          </Link>
      ...
      {/* STOPKA — kontakt, linki, admin i mapa na samym dole */}
      <footer className="px-6 pt-10 text-white/80 bg-black/80">
        <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-3">
          {/* kolumna 1 — adres/telefon */}
          <div>
            <div className="text-white font-bold text-lg mb-2">{CONTACT.name}</div>
          ...
          {/* kolumna 2 — linki 1 pod drugim z ikonkami */}
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href={CONTACT.fb} target="_blank" rel="noreferrer" className="hover:text-white underline">
                  Facebook
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href={CONTACT.ig} target="_blank" rel="noreferrer" className="hover:text-white underline">
                  Instagram
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href={CONTACT.gmb} target="_blank" rel="noreferrer" className="hover:text-white underline">
                  Google — wizytówka
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href={CONTACT.maps} target="_blank" rel="noreferrer" className="hover:text-white underline">
                  Jak dojechać
                </a>
              </li>
            </ul>
          ...
          {/* kolumna 3 — panel admina na dole strony */}
